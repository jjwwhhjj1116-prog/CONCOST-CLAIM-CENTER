...
export type ClaimCenterFolderKind =
  ...
  | 'COURT_DOCUMENT' | 'FINAL_DELIVERABLE' | 'INTAKE_AUDIO' | 'INTAKE_SOURCE' | 'MONTH';
...
const CLAIM_CENTER_FOLDER_KINDS = new Set<ClaimCenterFolderKind>([
  ...
  'COST_BREAKDOWN','REPORT_REFERENCE','COURT_DOCUMENT','FINAL_DELIVERABLE','INTAKE_AUDIO','INTAKE_SOURCE','MONTH'
]);
