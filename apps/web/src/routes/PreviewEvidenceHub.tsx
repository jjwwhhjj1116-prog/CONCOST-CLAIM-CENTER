  ...
  return <section className="route-view preview-drive-setup" aria-labelledby="preview-drive-title">
    ...
    {oauthApp && <section className="preview-drive-guide" aria-labelledby="google-drive-guide-title">
      ...
      <div className="preview-drive-guide-grid">
        ...
        <article><span>03</span><h4>Google 인증 플랫폼 · 브랜딩</h4><p>앱 이름은 <b>클레임센터 스튜디오</b>, 사용자 지원 이메일은 실제 확인 가능한 회사 이메일로 저장하세요. 미리보기 테스트 중에는 홈페이지·개인정보처리방침 URL을 억지로 입력하지 않아도 됩니다.</p><a href={GOOGLE_CONSOLE_LINKS.branding} target="_blank" rel="noreferrer">브랜딩 열기 ↗</a></article>
