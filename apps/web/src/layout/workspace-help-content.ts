...
export const ROUTE_HELP: Record<string, { title: string; steps: readonly string[]; next: string }> = {
  ...
  'PROP-02': { title: '제안서 작성', steps: ['의뢰 프로젝트·HWP 원본 템플릿 선택', 'Gemini로 1~3장 순차 초안 작성', '4~11장 회사 고정 모듈·이미지 배치 확인', '사람 편집·AI 문장 개선', '전체 미리보기 확정 후 HWP·DOCX·PDF·DB 보관'], next: '프로젝트 접수' },
